...
namespace Day05
{
    internal abstract class Person
    {
        ...
        {
            return $"SocialNumber :{this.socialNumber} | Full Name :{this.firstName} {this.lastName} | Email :{this.email} | BirthDay :{this.birthDay} | Total Revenue :{this.totalRevenue.ToString("C", new CultureInfo("Id-ID"))}";
        }
